...
CKEDITOR.plugins.add( 'powrsocialfeed', {
  icons: 'socialfeed',
  init: function( editor ) {
    editor.ui.addButton( 'powr_socialfeed', {
      label: 'Insert POWr Social Feed',
      command: 'insertpowrsocialfeed',
      toolbar: 'insert',
      icon: 'socialfeed'
    });
    editor.addCommand("insertpowrsocialfeed", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'social-feed');
      }
    });
    editor.ui.addRichCombo( 'powr_apps_dropdown', {
      label: '+ POWr',
